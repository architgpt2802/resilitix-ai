...
CREATE TABLE data_library.`EX_INF_001` (hex_id STRING, CID FLOAT64); -- Critical Infrastructure Density
...
CREATE TABLE data_library.`HP_HUR_002` (hex_id STRING, ve_ae_fraction FLOAT64); -- Storm Surge
